...
<body id="page-top">
  <!-- Navigation-->
  <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 shadow" id="mainNav" style="background-color: rgb(13 110 253 / 90%);">
    <div class="container-fluid px-4 px-lg-5">
      <a class="navbar-brand text-uppercase text-white" href="/#page-top">SMA NEGERI 1 KESESI</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <ul class="navbar-nav text-uppercase ms-auto my-2 my-lg-0">
          <li class="nav-item"><a class="nav-link text-white" href="/pilih">Vote</a></li>
        </ul>
      </div>
    </div>
  </nav>
