      ...
      <form action="<?= base_url(); ?>/admin/peserta/add" method="post">
        <div class="modal-body">
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input type="number" min="2010" class="form-control" name="tahun_ajaran" autocomplete="off" required>
            </div>
          </div>
        </div>
      ...
      <form action="<?= base_url(); ?>/admin/peserta/edit" method="post">
        <div class="modal-body">
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input type="number" min="2010" class="form-control" name="tahun_ajaran" autocomplete="off" id="tahun_ajaran" required>
            </div>
          </div>
    ...
    e.addEventListener("click", function(el) {
      ...
      xhr.onload = function() {
        if (xhr.status == 200) {
          ...
          tahun_ajaran.value = data.tahun_ajaran;
